...
from mailings.views import (AddArchiveView, AttemptListView, MailingCreateView, MailingDeleteView, MailingDetailView,
                            MailingListView, MailingUpdateView, MainTemplateView, MessageCreateView, MessageDeleteView,
...
urlpatterns = [
    ...
    path("recipient/<int:pk>/detail/", cache_page(60 * 5)(RecipientDetailView.as_view()), name="recipient_detail"),
    ...
    path("message/<int:pk>/detail/", cache_page(60 * 5)(MessageDetailView.as_view()), name="message_detail"),
    path("message/create/", MessageCreateView.as_view(), name="message_create"),
    path("message/<int:pk>/update/", MessageUpdateView.as_view(), name="message_update"),
    path("message/<int:pk>/delete/", MessageDeleteView.as_view(), name="message_delete"),
    path("mailing/", MailingListView.as_view(), name="mailing_list"),
    path("mailing/<int:pk>/detail/", cache_page(60 * 5)(MailingDetailView.as_view()), name="mailing_detail"),
